...
class InfoCharactersAdapter (private val characters:List<Character>,
                             private val onClickItem: OnClickListener): RecyclerView.Adapter<InfoCharactersAdapter.ViewHolder>()  {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): InfoCharactersAdapter.ViewHolder {
    ...
    override fun onBindViewHolder(holder: InfoCharactersAdapter.ViewHolder, position: Int) {
